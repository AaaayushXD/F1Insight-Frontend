    ...
    <section className="relative h-screen w-full overflow-hidden bg-[#0B0D10]">
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-center px-6 lg:px-8">
        ...
        >
          ...
          >
            Unlock elite predictive intelligence and race analytics. 
            Data-driven insights for the modern F1 enthusiast.
          </motion.p>
          ...
          >
            <motion.a
              href="/schedules"
              className="group flex items-center gap-2 bg-[#E10600] px-8 py-3.5 text-sm font-semibold text-white shadow-lg transition-all hover:bg-[#C90500]"
              whileHover={{ scale: 1.02, boxShadow: "0 10px 30px -10px rgba(225, 6, 0, 0.5)" }}
              whileTap={{ scale: 0.98 }}
            >
              EXPLORE INSIGHTS
