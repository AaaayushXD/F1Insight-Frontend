              ...
              >
                <Card className="h-full border-f1-graphite bg-f1-black hover:border-f1-red/50 transition-all hover:bg-f1-graphite/40 group overflow-hidden">
                  <div className="h-32 bg-f1-graphite/20 flex items-center justify-center relative group-hover:bg-f1-graphite/30 transition-colors">
                    <span className="font-orbitron text-4xl font-bold text-f1-white/10">
                      {circuit.circuitId.slice(0, 3).toUpperCase()}
                    </span>
                  </div>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-lg transition-colors">
                      <Flag className="h-4 w-4 text-f1-red shrink-0" />
                      <span className="group-hover:text-f1-red transition-colors">
                        {circuit.circuitName.split(" ")[0]}
                      </span>
                      <span className="text-f1-white">
                        {circuit.circuitName.split(" ").slice(1).join(" ")}
                      </span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
